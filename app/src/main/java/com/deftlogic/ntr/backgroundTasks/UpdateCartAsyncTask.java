...
/**
 * Created by omkardokur on 2/3/16.
 */
public class UpdateCartAsyncTask extends AsyncTask<ArrayList<Integer>,Void,Void> {
    Context mContext;
    int itemId;
    int itemQuantity;
    ...
    public UpdateCartAsyncTask(Context mContext) {
    ...
    protected Void doInBackground(ArrayList<Integer>... params) {
       ...
       // Log.e("itemId", String.valueOf(itemId) + " Quantity" + String.valueOf(itemQuantity));
        ...
        mContext.getContentResolver().update(FieldAssistContract.CartEntry.CONTENT_URI, contentValues, mSelection, mSelectionArgs);
